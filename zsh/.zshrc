...
plugins=(k git archlinux python z vi-mode zsh-autosuggestions colorize tmux extract virtualenvwrapper copydir dirhistory alias-tips git-extra-commands npm sudo yarn web-search zsh-syntax-highlighting)
